...
while True:
    ...
    if Command == '1':
        ...
        if Choice == 'g':
            print('-----------------------------------')
            print('Guests CANNOT Delete Books!')
            print('-----------------------------------')
        else:
            EnteredPassword = input('Enter Password to DELETE the Book: ')
            if EnteredPassword == User.Password:
                ...
                if DeletedBook:
                    ...
                    print('-----------------------------------')
                    print(f"The book [{BookName.title()}] has been deleted.")
                else:
                    print('-----------------------------------')
                    print(f"The book [{BookName.title()}] does NOT exist in the Library.")
            else:
                print('Incorrect Password. CANNOT Delete the Book!')
